			...
			foreach ($results as $row ){
				...
				echo '<ol style="list-style: none;" class="tree">';
					...
					$myquery_domain = $this->user_model->query_domain();
						echo '<li class="tree">';						
						$image_properties = array('src' => 'images/plus.gif','class' => 'flip_domain', 'id' => $habitat);
					...
					foreach ($myquery_domain->result() as $row ){
						...
						//echo '<li class="kingdom tree" id="'.$domain_id.'" style="display:none;">';
						...
						echo '<li class="kingdom tree" id="'.$domain_id.'" style="display:none;">';
							...
							echo img($line).img($image_properties).$domain_id;
							echo '<ol class="tree">';
